  ...
  <script src="https://cdn.datatables.net/1.10.16/js/dataTables.bootstrap4.min.js"></script>
      ...
      $(document).ready(function() {
            ...
            var table = $('#example').DataTable( {
              ...
              "ajax": {
                      url: 'http://35.187.245.178/ballbackend/webservice.php?operation=query&sessionName=65bf072b5c7fa8570c45c&query=select%20*%20from%20%20SMSIncome%20where%20bank=%27scb%27%20ORDER%20BY%20createdtime%20DESC;',
                      dataSrc: 'result',
           },
                // "order": [[ 2, "DESC" ]],
            "columns": [
